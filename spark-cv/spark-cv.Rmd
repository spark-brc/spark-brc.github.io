...
<div class="item3">
<a href="https://github.com/spark-brc/spark-brc.github.io/raw/master/spark-cv/spark-cv.pdf" class="icon-block">
<img class="top_aligned_image" src="cv_pdf.svg" width="130">
</a>
</div>
...
<!-- <div class="item3"> -->
<!-- <a href="https://spark-brc.github.io/spark-cv/" class="icon-block"> -->
<!-- <img class="top_aligned_image" src="cv_online.svg" width="130"> -->
<!-- </a> -->
<!-- </div> -->
...
```{r}
kable(conf_tbl[22:nrow(conf_tbl), ])
```
